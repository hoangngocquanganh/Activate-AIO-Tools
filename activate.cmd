...
echo:
echo:                 Phuong Phap Kich Hoat:
echo:
echo:             [1] HWID        ^|  Windows           ^|   Vinh Vien
echo:             [2] KMS38       ^|  Windows           ^|   Nam 2038 
echo:             [3] Online KMS  ^|  Windows / Office  ^|   180 Ngay
echo:             __________________________________________________      
echo:
echo:             [4] Trang Thai Kick Hoat
echo:             [5] Bo Sung
echo:             [6] Tro Giup
echo:             [0] Thoat                                 
echo:       ______________________________________________________________
echo:
call :_color2 %_White% "          " %_Green% "Nhap Mot Tuy Chon Tu Ban Phin [1,2,3,4,5,6,0] :"
choice /C:1234560 /N
set _erl=%errorlevel%
...
echo:       ______________________________________________________________
echo:
echo:             [1] Khac Phuc Su Co Kick Hoat
echo:             [2] Thay Doi Phien Ban Windows 
echo:
echo:             [3] Giai Nen Thu Muc $OEM$ 
echo:             [4] Chen Khoa Windows HWID 
echo:             [5] Trang Thai Kick Hoat [vbs]
echo:             __________________________________________________      
echo:                                                                     
echo:             [0] Di Chuyen Den Main Menu
echo:       ______________________________________________________________
echo:
call :_color2 %_White% "           " %_Green% "Nhap Mot Tuy Chon Tu Ban Phim [1,2,3,4,5,0] :"
choice /C:123450 /N
set _erl=%errorlevel%
...
echo:
call :_color %_Yellow% "Nhan Phim Bat Ky De Quay Tro Lai..."
pause >nul
goto Extras
)
...
echo:
echo:
echo:                    Gian Nen Thu Muc $OEM$ Tren Desktop              
echo:       ______________________________________________________________
echo:                                                            
echo:             [1] HWID
echo:             [2] KMS38
...
echo:       ______________________________________________________________
echo:  
call :_color2 %_White% "           " %_Green% "Nhap Mot Tuy Chon Tu Ban Phim:"
choice /C:123450 /N
set _erl=%errorlevel%
...
if %~z0 GEQ 200000 (set "_exitmsg=Quay Tro Lai") else (set "_exitmsg=Exit")
...
echo:
call :dk_color2 %_White% "     " %Green% "Kiem Tra: %winos% is Duoc Kick Hoat Vinh Vien."
call :dk_color2 %_White% "     " %Gray% "Kick Hoat Khong Bat Buoc."
echo ___________________________________________________________________________________________
if %_unattended%==1 goto dk_done
echo:
choice /C:10 /N /M ">    [1] Kick Hoat [0] %_exitmsg% : "
...
echo Enabling Windows Script Host            [Thanh Cong]
)
...
if %errorcode% EQU 0 (
call :dk_refresh
echo Cai Dat Generic Product Key          [%key%] [Thanh Cong]
) else (
set error=1
call :dk_color %Red% "Cai Dat Generic Product Key          [%key%] [Thai Bai] %errorcode%"
...
if !errorlevel! EQU 0 (
echo Changing Windows Region To USA          [Thanh Cong]
) else (
call :dk_color %Red% "Changing Windows Region To USA          [Thai Bai]"
)
)
...
call :dk_color %Red% "Generating GenuineTicket.xml           [Thai Bai]"
echo [%encoded%]
if exist "%tdir%\Genuine*" del /f /q "%tdir%\Genuine*" %nul%
goto :dl_final
) else (
echo Generating GenuineTicket.xml            [Thanh Cong]
)
...
%_xmlexist% (
if exist "%tdir%\*.xml" del /f /q "%tdir%\*.xml" %nul%
call :dk_color %Red% "Installed GenuineTicket.xml            [Failed With ClipSVC Service Restart, Wait...]"
)
)
...
call :dk_color %Red% "Deleting a Registry                     [Thai Bai] [!_ident!]"
) || (
echo Deleting a Registry                     [Thanh Cong][!_ident!]
)
...
if !errorlevel! EQU 0 (
echo Restoring Windows Region                [Thanh Cong]
) else (
call :dk_color %Red% "Restoring Windows Region                [Thai Bai][%name%-%nation%]"
)
)
...
if defined serv_csts echo Enabling Disabled Services              [Thanh Cong][%serv_csts%]

if defined serv_cste (
echo %serv_cste% | findstr /i "ClipSVC sppsvc" %nul% && (
call :dk_color %Red% "Enabling Disabled Services              [Thai Bai][%serv_cste%] [Restart System]"
) || (
call :dk_color %Red% "Enabling Disabled Services              [Thai Bai][%serv_cste%]"
)
)
...
if defined serv_e (
set error=1
call :dk_color %Red% "Starting Services                       [Thai Bai][%serv_e%]"
)
...
echo:
echo                 [1] Kick Hoat KMS38 
echo                 ____________________________________________
echo:
echo                 [2] Loai Bo Bao Ve KM38 
echo:
echo                 [0] %_exitmsg%
echo         ____________________________________________________________
echo: 
...
echo ___________________________________________________________________________________________
echo:
call :dk_color2 %_White% "     " %Green% "Dang Kiem Tra: %winos% is Duoc Kick Hoat Vinh Vien."
call :dk_color2 %_White% "     " %Gray% "Kick Hoat Khong Du Yeu Cau."
echo ___________________________________________________________________________________________
if %_unattended%==1 goto dk_done
echo:
choice /C:10 /N /M ">    [1]  Kick Hoat [0] %_exitmsg% : "
...
if !error_code! EQU 0 (
call :dk_refresh
echo Installing KMS Client Setup Key         [%key%] [Thanh Cong]
) else (
set error=1
call :dk_color %Red% "Installing KMS Client Setup Key         [%key%] [Thai Bai]!error_code!"
)
)
...
echo Adding Specific KMS Host                [LocalHost 127.0.0.2] [Thanh Cong]
) else (
call :dk_color %Red% "Adding Specific KMS Host                [LocalHost 127.0.0.2] [Thai Bai]"
)
...
echo:
if exist "!_clipup!" (
echo Copying clipup.exe File to              [%systemroot%\System32\] [Thanh Cong]
) else (
call :dk_color %Red% "Copying clipup.exe File to              [%systemroot%\System32\] [Thai Bai] Aborting..."
goto :k_final
)
)
...
echo Stopping sppsvc Service                 [Thanh Cong]
) || (
call :dk_color %Red% "Stopping sppsvc Service                [Thai Bai]"
)
...
if %errorlevel%==0 (
echo Applying SKU-ID Rearm                   [Thanh Cong]
) else (
call :dk_color %Red% "Applying SKU-ID Rearm                  [Thai Bai]"
)
call :dk_refresh
...
%nul% reg delete "HKU\S-1-5-20\%specific_kms%" /f
%nul% reg query "HKLM\%specific_kms%" && (
call :dk_color %Red% "Removing The Added Specific KMS Host    [Thai Bai]"
) || (
echo Removing The Added Specific KMS Host    [Thanh Cong]
)
)
...
%nul% reg delete "HKLM\%specific_kms%" /f
%nul% reg query "HKLM\%specific_kms%" && (
call :dk_color %Magenta% "Protect KMS38 By KMS                    [Thanh Cong][Locked A Registry Key]"
) || (
...
if defined a_cor (
if exist "%_clipup%" (
call :dk_color %Red% "Deleting copied clipup.exe file         [Thai Bai]"
) else (
echo Deleting copied clipup.exe file         [Thanh Cong]
)
)
...
echo:
%nul% reg query "HKLM\%specific_kms%" && (
call :dk_color %Red% "Loai Bo May Chu KMS              [Thai Bai]"
) || (
echo Loai Bo May Chu KMS              [Thanh Cong]
)
...
::  KMS38 protection stops 180 Ngay KMS Activation from replacing KMS38 activation
...
if %~z0 GEQ 300000 (set "_exitmsg=Quay Tro Lai") else (set "_exitmsg=Exit")
...
set "_title=Kick Hoat May Chu KMS Truc Tuyen"
set _gui=
...
echo.       ______________________________________________________________
echo.
echo.              [1]  Kick Hoat - Windows
echo.              [2]  Kick Hoat - Office
echo.              [3]  Kick Hoat- All
echo.
if defined _tskinstalled call :_color2 %_White% "              [4] Cai Dat Tu Dong Gia Han      " %_Green% "[Installed]"
if defined _oldtsk       call :_color2 %_White% "              [4] Cai Dat Tu Dong Gia Han      " %_Red% "[Old Installed]"
if not defined _tskinstalled if not defined _oldtsk echo.              [4] Cai Dat Tu Dong Gia Han
echo.              [5] Go Cai Dat Tu Dong Gia Han
echo.              _______________________________________________  
echo.
if %_Debug%==0 (
echo.              [6] Bat Che Do Sua Loi         [Khong]
) else (
call :_color2 %_White% "              [6] Bat Che Do Sua Loi           " %_Red% "[Co]"
)
if %vNextOverride% EQU 1 (
if %sub_next% EQU 1 (
call :_color2 %_White% "              [7] Ghi De Office vNext     " %_Red% "[Co]"
) else (
echo               [7] Ghi De Office vNext     [Co]
)
) else (
if %sub_next% EQU 1 (
call :_color2 %_White% "              [7] Ghi De vNext     " %_Yellow% "[Khong]"
) else (
echo               [7] Ghi De  Office vNext     [Khong]
)
)
echo.              _______________________________________________       
echo.
...
echo.       ______________________________________________________________
echo.
call :_color2 %_White% "           " %_Green% "Nhap Mot Tuy Chon Tu Ban Phim [1,2,3,4,5,6,7,0]"
choice /C:12345670 /N
set _el=%errorlevel%
...
echo.
echo Nhan Phim Bat Ky De Quay Tro Lai...
pause >nul
exit /b
...
if %ActOffice% EQU 0 (echo.&echo Kick Hoat Office Dang Tat...)
...
if %WinVL% EQU 0 (
if %ActWindows% EQU 0 (
  echo.&echo Kich Hoat Windows Dang Duoc Tat ...
  ) else (
  if %SSppHook% EQU 0 (
...
if %W1nd0ws% EQU 1 if %ActWindows% EQU 0 (echo.&echo Kich Hoat Windows Dang Duoc Tat ...)
...
if %winbuild% GEQ 9200 (
  if %OffUWP% EQU 0 (echo.&echo Khong Phat Hien San Pham Office 2013-2021 Da Duoc Cai Dat...) else (echo.&echo %_mOuwp%)
  exit /b
  )
if %winbuild% LSS 9200 (if %loc_off14% EQU 0 (echo.&echo Khong Phat Hien San Pham Office %aword% Duoc Cai Dat...&exit /b))
)
...
if %WinPerm% EQU 1 (
for /f "tokens=2 delims==" %%x in ('%_qr%') do echo Dang Kiem Tra: %%x
echo San Pham Da Duoc Kich Hoat Vinh Vien.
exit /b
)
call :insKey
exit /b
...
if %OsppHook% EQU 0 (echo.&echo Khong Phat Hien San Pham Office %aword% Da Cai Dat...&exit /b)
if %winbuild% GEQ 9200 if %loc_off14% EQU 0 (echo.&echo Khong Phat Hien San Pham Office %aword% Da Cai Dat...&exit /b)
set err_offsvc=0
...
if "%ls3%"=="1" (
echo Dang Kiem Tra: %~6
echo San Pham Da Duoc Kich Hoat Vinh Vien.
exit /b
)
if "%ls2%"=="1" (
echo Dang Kiem Tra: %~4
echo San Pham Da Duoc Kich Hoat Vinh Vien.
exit /b
)
if "%ls%"=="1" (
echo Dang Kiem Tra: %~2
echo San Pham Da Duoc Kich Hoat Vinh Vien.
exit /b
)
call :insKey
...
if %ESU_ADD% EQU 0 for /f "tokens=2 delims==" %%x in ('%_qr%') do echo Kick Hoat: %%x
if %ESU_ADD% EQU 1 for /f "tokens=2 delims==f" %%x in ('%_qr%') do echo Kick Hoat: %%x
)
...
echo Product Activation succeeded, but Thoi Gian Con Lai failed to increase.
...
call :_color %_Green% "Kick Hoat San Pham Thanh Cong"
echo Thoi Gian Con Lai: %gpr2% Ngay ^(%gpr% Phut^)
set /a act_attempt=0
exit /b
)
...
if %_C16Msg% EQU 1 (
echo.
echo Chuyen Doi Office C2R Retail-to-Volume:
)
...
echo Giu Dia Chi IP Khong Ton Tai  10.0.0.10 Nhu KMS Server.
) else (
...
echo %_dest%\Info.txt
echo.
(if defined ActTask (echo Scheduled Tasks created:) else (echo Khoi Tao Tac Vu Theo Lich Trinh:))
echo \Activation-Renewal [Hang Tuan]
...
echo.
if defined ActTask (
call :_color %Green% "Lich Trinh Gia Han Da Tao Thanh Cong."
) else (
call :_color %Green% "Lich Trinh Gia Han Da Tao Thanh Cong."
)
echo.
...
echo.
echo Nhan Phim Bat Ky De Quay Thoat
pause >nul
exit /b
)
...
echo.
echo Khong Phat Hien San Pham Volume Windows / Office Duoc Cai Dat
echo.
...
echo Dang Kiem Tra: Volume version of Windows is not installed
)
...
echo.
echo Dang Kiem Tra: Volume version of Office is not installed
)
...
if %_wmic% EQU 1 for /f "tokens=2 delims==" %%x in ('"wmic path !_path! where ID='!_actid!' get Name /VALUE" 2^>nul') do call echo Kick Hoat: %%x
if %_wmic% EQU 0 for /f "tokens=2 delims==" %%x in ('%psc% "(([WMISEARCHER]'SELECT Name FROM !_path! WHERE ID=''!_actid!''').Get()).Name | %% {echo ('Name='+$_)}" 2^>nul') do call echo Kick Hoat: %%x
exit /b
...
echo %line%
echo:
choice /C:09 /N /M ">    [9] Continue [0] Quay Tro Lai : "
...
echo %line%
echo:
choice /C:09 /N /M ">    [9] Tiep Tuc [0] Quay Tro Lai : "
if %errorlevel%==1 goto at_menu
...
echo %line%
echo:
choice /C:01 /N /M ">    [1] Tiep Tuc  [0] Quay Tro Lai : "
if %errorlevel%==1 goto at_menu
...
call :_color %Red% "[Thai Bai] Huy Bo..."
goto :wmifixend
)
...
call :_color %Red% "[Thai Bai] Aborting..."
goto :wmifixend
)
...
echo:
echo Nhan Phim Bat Ky De %_exitmsg%...
pause >nul
exit /b
...
cls
color 07
title  Cai Dat Windows HWID Key
...
call :dk_refresh
call :dk_channel
call echo Cai Dat %%_channel%% [%key%]
echo:
...
%line%
echo:
echo  Nhap Mot Tuy Chon Tu Ban Phim :
choice /C:120 /N
set _el=!errorlevel!
